...
export function Toast({ children, onClose }: ToastProps) {
  return (
    <div
      role="status"
      aria-live="polite"
      className="pointer-events-auto flex min-h-9 w-[calc(100vw-3rem)] max-w-[426px] items-center justify-between gap-4 rounded-[9999px] border border-brand-neutral-900 bg-brand-neutral-0 px-4 py-2 text-brand-neutral-900 shadow-[0_3px_8px_0_rgba(46,20,1,0.28),2px_2px_0_0_var(--color-brand-neutral-900)] sm:min-h-12 sm:px-6 sm:py-3"
    >
